            ...
            [
                {
                    ...
                    "content": (
                        ...
                        "for the given task.\n\n"
                        "Pre-installed libraries: numpy, scipy, matplotlib, pandas, math, statistics, "
                        "urllib.request, urllib.parse, json, datetime, csv, io, openpyxl, requests.\n\n"
                        "You can use ANY PyPI package — missing packages are auto-installed at runtime. "
                        "Simply import them normally (e.g., `import seaborn`, `import sklearn`, "
                        "`import plotly`, `import yfinance`). If a package needs a specific pip name "
                        "that differs from the import name, add a comment like: # pip: scikit-learn\n"
                        "For packages that require system dependencies or take very long to compile, "
                        "prefer pure-Python alternatives when possible.\n\n"
